...
{
    private List<Domain.Managers.Manager> _managers = new();
    private List<Residence> _residences = new();
    private List<Domain.Students.Student> _students = new();
    ...
    private IEnumerable<Domain.Managers.Manager> GetFilteredManagers()
    {
    ...
    private double CalculateOccupancyRate(Domain.Managers.Manager manager)
    {
    ...
    private void ViewDetails(Domain.Managers.Manager manager)
    {
        Navigation.NavigateTo($"/admin/managers/{manager.Id}");
    }

    private void EditManager(Domain.Managers.Manager manager)
    {
        Navigation.NavigateTo($"/admin/managers/edit/{manager.Id}");
    }

    private void AssignResidences(Domain.Managers.Manager manager)
    {
        Navigation.NavigateTo($"/admin/managers/{manager.Id}/assign-residences");
    }

    private async Task SetOnLeave(Domain.Managers.Manager manager)
    {
    ...
    private async Task SetActive(Domain.Managers.Manager manager)
    {
    ...
    private async Task DeleteManager(Domain.Managers.Manager manager)
    {
        var parameters = new DialogParameters<ConfirmDialog>
        {
            {
    ...
    private class ManagerPerformance
    {
