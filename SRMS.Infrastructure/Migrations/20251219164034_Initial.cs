        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateFeeCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Managers_EmployeeNumber",
                table: "Managers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Managers_Status",
                table: "Managers",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_Managers_Status_Active_Deleted",
                table: "Managers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Residence_RoomNumber",
                table: "Rooms",
                columns: new[] { "ResidenceId", "RoomNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_Status_Active_Deleted",
                table: "Students",
                columns: new[] { "Status", "IsActive", "IsDeleted" });
